...
public class CopyFileVisitor implements FileVisitor {
    ...
    @Override
    public FileVisitResult preVisitDirectory(Object dir, BasicFileAttributes basicFileAttributes) throws IOException {
    ...
    @Override
    public FileVisitResult visitFile(Object file, BasicFileAttributes basicFileAttributes) throws IOException {
